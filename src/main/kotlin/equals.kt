fun main(args:Array<String>){
    ...
    //person1 과 person3 가 동일한 인스턴스이므로 true
    ...
    //==저장하고 있는 데이터가 같은지 비교
    //=== 동일한 참조인지 비교
    //숫자 데이터를 생성자 이용해서 생성하면
    //동일한 숫자라면 == 는 true를 리턴하고
    //===는 false를 리턴

//    val n1 = Integer(value:500)
//    val n2 = Integer(value:500)
//    val n3 = n1
...
//    println(n1 === n3)
    ...
    val n4 = 500
    val n5 = 500
    print(n4 === n5) //참조를 비교 : false

//    println("5 in 1..10 => %{5 in 1..10}")
//    println("5 in 10..1 => %{5 in 10..1}")
//    println("5 in 10 downTo 1 => %{5 in 10 downTo 1}")
//    println("5 in 1..10 downTo 3 => %{5 in 1 .. 10 step 3}")

    println("5 in 10..1 => ${5 in 1..10}")
    println("5 in 10..1 => ${5 in 10..1}")


    //?: null 이면 뒤의 식을 리턴 그렇지 않으면 앞의 식을 리턴
    var x : Int? = 20
    println("${x?:100}")
    x = null
    println("${x?:100}")
